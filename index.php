...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- divs de conteneur et de ligne pour le responsive -->

            <!-- leftComponent -->
            <div class="leftComponent col-md-5">
                <img src="img/logo.png" alt="Leave Image" class="img-fluid">
            </div>
            <!-- leftComponent ends -->
    ...
    <footer class="footer navbar navbar-expand-lg navbar-light bg-light" style="color:white;">
        <div>
            <p class="text-center">&copy; <?php echo date("Y"); ?> - HR Management</p>
