<aside id="logo-sidebar" class="z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 shadow-md" aria-label="Sidebar">
