...
<body>
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <ul class="nav justify-content-end">
            ...
            <li class="nav-item">
                <a class="nav-link" href="myhistory.php" style="color:white;">Historique</a>
            </li>
            <li class="nav-item">
  ...
  <h1>Demande de Congé/Permission</h1>
  ...
  <div class="container">
    ...
    <form method="POST">
      ...
      <label><b>Precisez votre choix :</b></label>
      <!-- error message if type of absence isn't selected -->
      <span class="error"><?php echo "&nbsp;".$absenceErr ?></span><br/>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Congé" id="Congé">
        <label class="form-check-label" for="Congé">
          Congé
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Malade" id="Malade">
        <label class="form-check-label" for="Malade">
          Malade
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Occasionnel" id="Occasionnel">
        <label class="form-check-label" for="Occasionnel">
        Occasionnel
        </label>
      </div>
      
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Deuil" id="Deuil">
        <label class="form-check-label" for="Deuil">
        Deuil
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Congés sans solde" id="Congés sans solde">
        <label class="form-check-label" for="Congés sans solde">
        Congés sans solde
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Maternité / Paternité" id="Maternité / Paternité">
        <label class="form-check-label" for="Maternité / Paternité">
        Maternité / Paternité
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Sabbatique" id="Sabbatique">
        <label class="form-check-label" for="Sabbatique">
        Sabbatique
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Autre" id="Autre">
      ...
      <div class="mb-3">
        ...
        <label for="leaveDesc" class="form-label"><b>Preciser la raison de votre demande:</b></label>
        <!-- error message if reason of the leave is not given -->
        <span class="error"><?php echo "&nbsp;".$reasonErr ?></span>
        <textarea class="form-control" name="reason" id="leaveDesc" rows="4" placeholder="Saisissez votre raison ici..."></textarea>
      </div>
